...
1. Team Members: Brian Rouse
2. App Name: `Covid-19`
3. App Description Covid-19 will be an app that tracks the pandemic globally. It will show real time death rates as well as recovery rates, confirmed cases.

    ``
    
4. Your #1 Customer Anyone following the corona virus.
 
    Anyone on a global level interested in tracking the pandemics data would use this app.
    
5. Github code repository: `https://github.com/brouse3815/Covid_19_iOS`
